...
export class DashboardPage extends React.Component<DashboardPageProps, DashboardPageState> {
  ...
  render(): React.ReactNode {
    ...
    return <main className="dashboard-page" aria-labelledby="dashboard-title">
      <PageHeader title={<span id="dashboard-title">Dashboard</span>} subtitle="Brauhaus auf einen Blick" actions={this.props.isFetching ? <span className="dashboard-loading">Dashboard-Daten werden geladen …</span> : undefined} />
