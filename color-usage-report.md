...
src/containers/Settings/SettingsPage/SettingsPage.css:21:  color: #b26a00;
src/containers/Settings/SettingsPage/SettingsPage.css:32:  color: #444;
src/containers/Settings/SettingsPage/SettingsPage.css:50:  background: #43a047;
src/containers/Settings/SettingsPage/SettingsPage.css:56:  background: #e8f5e9;
src/containers/Settings/SettingsPage/SettingsPage.css:57:  color: #1b5e20;
src/containers/Settings/SettingsPage/SettingsPage.css:58:  border: 1px solid #c8e6c9;
src/containers/Settings/SettingsPage/SettingsPage.css:90:  color: #555;
src/containers/Settings/SettingsPage/SettingsPage.css:113:  color: #666;
src/containers/Settings/SettingsPage/SettingsPage.css:134:  background: linear-gradient(180deg, #ffb74d 10%, #ff9800 100%);
src/containers/Settings/SettingsPage/SettingsPage.css:135:  color: #5d3300;
src/containers/Settings/SettingsPage/SettingsPage.css:136:  border-color: #b26a00;
src/containers/Settings/SettingsPage/SettingsPage.css:177:  background: linear-gradient(180deg, #ffb74d 10%, #ff9800 100%);
src/containers/Settings/SettingsPage/SettingsPage.css:178:  border: 1px solid #b26a00;
src/containers/Settings/SettingsPage/SettingsPage.css:179:  color: #5d3300;
src/containers/Settings/SettingsPage/SettingsPage.css:197:  color: #666;
...
src/containers/DatabaseOverview/BeerForm/BeerForm.css:42:    color: #ffffff;
src/containers/DatabaseOverview/BeerForm/BeerForm.css:51:    color: #ffffff;
src/containers/DatabaseOverview/BeerForm/BeerForm.css:61:    background-color: var(--color-accent); /* Geändert von #007bff zu var(--color-accent) für Konsistenz */
src/containers/DatabaseOverview/BeerForm/BeerForm.css:62:    color: #fff;
src/containers/DatabaseOverview/BeerForm/BeerForm.css:79:    color: #fff;
src/containers/DatabaseOverview/BeerForm/BeerForm.css:86:    background-color: #c96a00; /* Dunklere Version der darkorange Farbe */
src/containers/DatabaseOverview/BeerForm/BeerForm.css:140:    border: 1px solid #555;
src/containers/DatabaseOverview/BeerForm/BeerForm.css:149:    background: #333;
src/containers/DatabaseOverview/BeerForm/BeerForm.css:154:    background: #666;
src/containers/DatabaseOverview/BeerForm/BeerForm.css:159:    background: #888;
src/containers/DatabaseOverview/BeerForm/BeerForm.css:172:    background-color: #555;
src/containers/DatabaseOverview/BeerForm/BeerForm.css:183:    background-color: #4a4a4a;
src/containers/DatabaseOverview/BeerForm/BeerForm.css:187:    background-color: #3a3a3a;
src/containers/DatabaseOverview/BeerForm/BeerForm.css:269:    color: #fff;
src/containers/DatabaseOverview/BeerForm/BeerForm.css:279:    background-color: #c96a00;
src/containers/DatabaseOverview/BeerForm/BeerForm.css:280:    color: #fff;
src/containers/DatabaseOverview/BeerForm/BeerForm.css:289:    background-color: #e0e0e0;
src/containers/DatabaseOverview/BeerForm/BeerForm.css:290:    color: #bdbdbd;
src/containers/DatabaseOverview/BeerForm/BeerForm.css:294:    border: 1px solid #cccccc;
src/containers/DatabaseOverview/BeerForm/BeerForm.css:299:    color: #fff;
src/containers/DatabaseOverview/BeerForm/BeerForm.css:309:    background-color: #d32f2f;
src/containers/DatabaseOverview/BeerForm/BeerForm.css:310:    color: #fff;
src/containers/DatabaseOverview/IngredientsFormPage/IngredientsFormPage.tsx:118:                    <Accordion defaultExpanded sx={{ backgroundColor: "#404040" }}>
src/containers/DatabaseOverview/IngredientsFormPage/IngredientsFormPage.tsx:126:                        <AccordionDetails sx={{ backgroundColor: "#404040" }}>
src/containers/DatabaseOverview/IngredientsFormPage/IngredientsFormPage.tsx:201:                    <Accordion sx={{ backgroundColor: "#404040" }}>
src/containers/DatabaseOverview/IngredientsFormPage/IngredientsFormPage.tsx:209:                        <AccordionDetails sx={{ backgroundColor: "#404040" }}>
src/containers/DatabaseOverview/IngredientsFormPage/IngredientsFormPage.tsx:283:                    <Accordion sx={{ backgroundColor: "#404040" }}>
src/containers/DatabaseOverview/IngredientsFormPage/IngredientsFormPage.tsx:291:                        <AccordionDetails sx={{ backgroundColor: "#404040" }}>
...
src/containers/DatabaseOverview/IngredientsFormPage/IngredientsFormPage.css:18:    background-color: #404040 !important;
src/containers/DatabaseOverview/IngredientsFormPage/IngredientsFormPage.css:25:    background-color: #404040 !important;
src/containers/DatabaseOverview/IngredientsFormPage/IngredientsFormPage.css:35:    border-bottom: 2px solid #222 !important;
src/containers/DatabaseOverview/IngredientsFormPage/IngredientsFormPage.css:44:    background-color: #404040 !important;
src/containers/DatabaseOverview/IngredientsFormPage/IngredientsFormPage.css:46:    border-bottom: 1px solid #555 !important;
src/containers/DatabaseOverview/IngredientsFormPage/IngredientsFormPage.css:52:    background-color: #404040 !important;
src/containers/DatabaseOverview/IngredientsFormPage/IngredientsFormPage.css:61:    border: 1px solid #666;
src/containers/DatabaseOverview/BeerForm/BeerForm.tsx:543:                                                            color: '#333',
src/containers/DatabaseOverview/BeerForm/BeerForm.tsx:544:                                                            border: `1px solid #ced4da`,
src/containers/DatabaseOverview/BeerForm/BeerForm.tsx:596:                                <thead style={{position: 'sticky', top: 0, background: '#fff', zIndex: 2}}>
src/containers/DatabaseOverview/BeerForm/BeerForm.tsx:653:                                <thead style={{position: 'sticky', top: 0, background: '#fff', zIndex: 2}}>
src/containers/DatabaseOverview/BeerForm/BeerForm.tsx:721:                                <thead style={{position: 'sticky', top: 0, background: '#fff', zIndex: 2}}>
...
src/containers/MainView/FinishBrewsBeers/FinishedBrewsTable/FinishedBrewsTable.css:9:  background-color: #404040; /* wie Table.css */
src/containers/MainView/FinishBrewsBeers/FinishedBrewsTable/FinishedBrewsTable.css:60:  color: #fff;
src/containers/MainView/FinishBrewsBeers/FinishedBrewsTable/FinishedBrewsTable.css:76:  background-color: #ffa726;
src/containers/MainView/FinishBrewsBeers/FinishedBrewsTable/FinishedBrewsTable.css:77:  color: #222;
src/containers/MainView/FinishBrewsBeers/FinishedBrewsTable/FinishedBrewsTable.css:81:  background-color: #bdbdbd;
src/containers/MainView/FinishBrewsBeers/FinishedBrewsTable/FinishedBrewsTable.css:82:  color: #888;
src/containers/MainView/FinishBrewsBeers/FinishedBrewsTable/FinishedBrewsTable.css:90:  color: #fff;
src/containers/MainView/FinishBrewsBeers/FinishedBrewsTable/FinishedBrewsTable.css:100:  background-color: #d32f2f;
src/containers/MainView/FinishBrewsBeers/FinishedBrewsTable/FinishedBrewsTable.css:101:  color: #fff;
src/containers/MainView/FinishBrewsBeers/FinishedBrewsTable/FinishedBrewsTable.css:105:  background-color: #2e7d32 !important; /* Grüner Hintergrund für aktive Zeile */
src/containers/MainView/FinishBrewsBeers/FinishedBrewsTable/FinishedBrewsTable.css:106:  color: #fff;
src/containers/MainView/FinishBrewsBeers/FinishedBrewsTable/FinishedBrewsTable.css:118:  background: #404040;
src/containers/MainView/FinishBrewsBeers/FinishedBrewsTable/FinishedBrewsTable.css:120:  border: 1px solid #888;
src/containers/MainView/FinishBrewsBeers/FinishedBrewsTable/FinishedBrewsTable.css:135:  background: #404040;
src/containers/MainView/FinishBrewsBeers/FinishedBrewsTable/FinishedBrewsTable.css:175:  color: #fff;
src/containers/MainView/FinishBrewsBeers/FinishedBrewsTable/FinishedBrewsTable.css:185:  background-color: #c96a00;
src/containers/MainView/FinishBrewsBeers/FinishedBrewsTable/FinishedBrewsTable.css:186:  color: #fff;
src/containers/MainView/FinishBrewsBeers/FinishedBrewsTable/FinishedBrewsTable.css:195:  background-color: #e0e0e0;
src/containers/MainView/FinishBrewsBeers/FinishedBrewsTable/FinishedBrewsTable.css:196:  color: #bdbdbd;
src/containers/MainView/FinishBrewsBeers/FinishedBrewsTable/FinishedBrewsTable.css:200:  border: 1px solid #cccccc;
src/containers/MainView/FinishBrewsBeers/FinishedBrewsTable/FinishedBrewsTable.css:225:  background: #333333;
src/containers/MainView/FinishBrewsBeers/FinishedBrewsTable/FinishedBrewsTable.css:231:  background: #333333;
src/containers/MainView/FinishBrewsBeers/BrewProcessChart/BrewProcessChart.css:20:  background-color: #f5f5f5;
src/containers/MainView/FinishBrewsBeers/BrewProcessChart/BrewProcessChart.css:21:  color: #333;
src/containers/MainView/FinishBrewsBeers/BrewProcessChart/BrewProcessChart.css:26:  background-color: #ff9800;
src/containers/MainView/FinishBrewsBeers/BrewProcessChart/BrewProcessChart.css:39:  background: #ffffff;
src/containers/MainView/FinishBrewsBeers/BrewProcessChart/BrewProcessChart.css:40:  border: 2px solid #ff9800;
src/containers/MainView/FinishBrewsBeers/BrewProcessChart/BrewProcessChart.css:49:  background: #333333;
src/containers/MainView/FinishBrewsBeers/BrewProcessChart/BrewProcessChart.css:50:  color: #ffffff;
src/containers/MainView/FinishBrewsBeers/BrewProcessChart/BrewProcessChart.css:71:  stroke: #ff9800;
src/containers/MainView/FinishBrewsBeers/BrewProcessChart/BrewProcessChart.tsx:148:    const areaColors = ['#ffe0b2', '#c8e6c9', '#bbdefb', '#f8bbd0', '#d1c4e9', '#fff9c4'];
src/containers/MainView/FinishBrewsBeers/BrewProcessChart/BrewProcessChart.tsx:173:      HEATING: '#ffe082',
src/containers/MainView/FinishBrewsBeers/BrewProcessChart/BrewProcessChart.tsx:174:      WAITING_FOR_MASHING_IN: '#b3e5fc',
src/containers/MainView/FinishBrewsBeers/BrewProcessChart/BrewProcessChart.tsx:175:      RUNNING: '#c8e6c9',
src/containers/MainView/FinishBrewsBeers/BrewProcessChart/BrewProcessChart.tsx:176:      WAITING_FOR_IODINE_TEST: '#f8bbd0',
src/containers/MainView/FinishBrewsBeers/BrewProcessChart/BrewProcessChart.tsx:177:      WAITING_FOR_COOKING_START: '#d1c4e9',
src/containers/MainView/FinishBrewsBeers/BrewProcessChart/BrewProcessChart.tsx:178:      WAITING_FOR_WATER_BOIL: '#fff9c4',
src/containers/MainView/FinishBrewsBeers/BrewProcessChart/BrewProcessChart.tsx:179:      BREWING_FINISHED: '#ffccbc',
src/containers/MainView/FinishBrewsBeers/BrewProcessChart/BrewProcessChart.tsx:180:      default: '#eeeeee'
src/containers/MainView/FinishBrewsBeers/BrewProcessChart/BrewProcessChart.tsx:319:              <Line type="monotone" dataKey="Temperature" stroke="#FF0000" name="Ist-Temperatur" dot={false} />
src/containers/MainView/FinishBrewsBeers/BrewProcessChart/BrewProcessChart.tsx:320:              <Line type="monotone" dataKey="TargetTemperature" stroke="#FFFD00" name="Soll-Temperatur" dot={false} />
...
src/containers/MainView/Header/StatusDisplay/StatusDisplay.css:7:  color: #333;
src/containers/MainView/Header/StatusDisplay/StatusDisplay.css:8:  background: linear-gradient(180deg, #ff9800 60%, #e65100 100%);
src/containers/MainView/Header/StatusDisplay/StatusDisplay.css:9:  border: 2px inset #b26a00;
src/containers/MainView/Header/StatusDisplay/StatusDisplay.css:11:  box-shadow: 0 1px 2px #b26a00 inset, 0 1.5px 0 #fff;
src/containers/MainView/Header/StatusDisplay/StatusDisplay.css:22:  color: #fff;
src/containers/MainView/Header/StatusDisplay/StatusDisplay.css:30:  text-shadow: 0 1px 2px #e65100;
src/containers/MainView/Header/StatusDisplay/StatusDisplay.css:34:  color: #43a047;
src/containers/MainView/Header/StatusDisplay/StatusDisplay.css:35:  text-shadow: 0 1px 2px #1b5e20;
src/containers/MainView/Header/StatusDisplay/StatusDisplay.css:39:  color: #e53935;
src/containers/MainView/Header/StatusDisplay/StatusDisplay.css:40:  text-shadow: 0 1px 2px #b71c1c;
src/containers/MainView/Header/StatusDisplay/StatusDisplay.css:49:  border-bottom: 1px solid #b26a00;
src/containers/MainView/Header/StatusDisplay/StatusDisplay.css:63:  color: #fff;
src/containers/MainView/Header/StatusDisplay/StatusDisplay.css:64:  background: #e65100;
src/containers/MainView/Header/StatusDisplay/StatusDisplay.css:66:  border: 1.5px solid #b26a00;
src/containers/MainView/Header/StatusDisplay/StatusDisplay.css:73:  background: #ff9800;
src/containers/MainView/Header/StatusDisplay/StatusDisplay.css:74:  color: #fff;
src/containers/MainView/Header/StatusDisplay/StatusDisplay.css:92:  color: #000;
